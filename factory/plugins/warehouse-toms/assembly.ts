...
//  Warehouse Toms — GENERATED by factory/drums/build.mjs. Edit the sources:

//    factory/drums/common.ts

//    factory/drums/tr909/voices.ts

//    factory/drums/tr909/toms.ts
...
const P_LT_TUNE: i32 = 0;
const P_LT_LEV: i32 = 1;
const P_LT_DEC: i32 = 2;
const P_MT_TUNE: i32 = 3;
const P_MT_LEV: i32 = 4;
const P_MT_DEC: i32 = 5;
const P_HT_TUNE: i32 = 6;
const P_HT_LEV: i32 = 7;
const P_HT_DEC: i32 = 8;
const P_WIDTH: i32 = 9;
const P_AC: i32 = 10;
const P_VELMODE: i32 = 11;
const P_DRIVE: i32 = 12;
const NUM_PARAMS: i32 = 13;
function setDefaults(): void {
  params[0] = 0.5;   // Low Tune
  params[1] = 0.8;   // Low Level
  params[2] = 0.5;   // Low Decay
  params[3] = 0.5;   // Mid Tune
  params[4] = 0.8;   // Mid Level
  params[5] = 0.5;   // Mid Decay
  params[6] = 0.5;   // Hi Tune
  params[7] = 0.8;   // Hi Level
  params[8] = 0.5;   // Hi Decay
  params[9] = 0.4;   // Stereo Width
  params[10] = 0.6;   // Accent
  params[11] = 0.0;   // Velocity Mode
  params[12] = 0.0;   // Drive
}
