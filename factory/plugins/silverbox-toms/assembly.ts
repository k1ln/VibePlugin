...
//  Silverbox Toms — GENERATED by factory/drums/build.mjs. Edit the sources:

//    factory/drums/common.ts

//    factory/drums/tr606/voices.ts

//    factory/drums/tr606/toms.ts
...
const P_HT_LEV: i32 = 1;
const P_LT_TUNE: i32 = 2;
const P_HT_TUNE: i32 = 3;
const P_DEC: i32 = 4;
const P_WIDTH: i32 = 5;
const P_AC: i32 = 6;
const P_VELMODE: i32 = 7;
const P_DRIVE: i32 = 8;
const NUM_PARAMS: i32 = 9;
function setDefaults(): void {
  params[0] = 0.8;   // Low Level
  params[1] = 0.8;   // High Level
  params[2] = 0.0;   // Mod Low Tune
  params[3] = 0.0;   // Mod High Tune
  params[4] = -0.05;   // Mod Decay
  params[5] = 0.4;   // Stereo Width
  params[6] = 0.6;   // Accent
  params[7] = 0.0;   // Velocity Mode
  params[8] = 0.0;   // Drive
}
