// =====================================================================
//  FOREBEAR — a 2-oscillator semi-modular MONO synth in the American
//  ladder-filter lineage (the friendly "first patchable synth"). Two
//  Minimoog-style oscillators (saw <-> square morph, osc2 tunable to an
//  interval) sum into a warm 4-pole transistor-ladder low-pass with its
//  own snappy ADSR, a free-running LFO, a clocked sample & hold, a noise
//  source and a built-in spring reverb. The signature is the PATCHBAY: a
//  5x4 modulation matrix (LFO/Env/S&H/Noise/Osc2 -> Pitch/Cutoff/PWM/Verb)
//  whose routing amounts ARE parameters — cabling a source to a destination
//  in the GUI turns that amount up, so the patch you see is the patch you
//  hear. Normalled defaults (Env->Cutoff, a touch of LFO->PWM) make it sing
//  unpatched. Mono, last-note priority. No host imports, no alloc in process().
// =====================================================================
