...
//  Bridgewell Toms — GENERATED by factory/drums/build.mjs. Edit the sources:

//    factory/drums/common.ts

//    factory/drums/tr808/voices.ts

//    factory/drums/tr808/toms.ts
...
const P_LT_LEV: i32 = 0;
const P_LT_TUNE: i32 = 1;
const P_MT_LEV: i32 = 2;
const P_MT_TUNE: i32 = 3;
const P_HT_LEV: i32 = 4;
const P_HT_TUNE: i32 = 5;
const P_SWITCH: i32 = 6;
const P_WIDTH: i32 = 7;
const P_AC: i32 = 8;
const P_VELMODE: i32 = 9;
const P_DRIVE: i32 = 10;
const NUM_PARAMS: i32 = 11;
function setDefaults(): void {
  params[0] = 0.8;   // Low Level
  params[1] = 0.5;   // Low Tuning
  params[2] = 0.8;   // Mid Level
  params[3] = 0.5;   // Mid Tuning
  params[4] = 0.8;   // Hi Level
  params[5] = 0.5;   // Hi Tuning
  params[6] = 0.0;   // Tom/Conga
  params[7] = 0.4;   // Stereo Width
  params[8] = 0.6;   // Accent
  params[9] = 0.0;   // Velocity Mode
  params[10] = 0.0;   // Drive
}
