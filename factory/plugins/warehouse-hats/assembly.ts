...
//  Warehouse Hats — GENERATED by factory/drums/build.mjs. Edit the sources:

//    factory/drums/common.ts

//    factory/drums/tr909/voices.ts

//    factory/drums/tr909/hats.ts
...
const P_LEV: i32 = 0;
const P_CH_DEC: i32 = 1;
const P_OH_DEC: i32 = 2;
const P_AC: i32 = 3;
const P_VELMODE: i32 = 4;
const P_DRIVE: i32 = 5;
const NUM_PARAMS: i32 = 6;
function setDefaults(): void {
  params[0] = 0.8;   // Level
  params[1] = 0.4;   // Closed Decay
  params[2] = 0.45;   // Open Decay
  params[3] = 0.6;   // Accent
  params[4] = 0.0;   // Velocity Mode
  params[5] = 0.0;   // Drive
}
