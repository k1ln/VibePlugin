...
//  Bridgewell Bass — GENERATED by factory/drums/build.mjs. Edit the sources:

//    factory/drums/common.ts

//    factory/drums/tr808/voices.ts

//    factory/drums/tr808/bass.ts
...
const P_TONE: i32 = 1;
const P_DEC: i32 = 2;
const P_RELEASE: i32 = 3;
const P_GLIDE: i32 = 4;
const P_GLIDE_MODE: i32 = 5;
const P_SIGH: i32 = 6;
const P_CLICK: i32 = 7;
const P_DRIVE: i32 = 8;
const P_OCTAVE: i32 = 9;
const P_BEND_RANGE: i32 = 10;
const P_AC: i32 = 11;
const P_VELMODE: i32 = 12;
...
function setDefaults(): void {
  ...
  params[4] = 0.25;   // Glide
  params[5] = 1.0;   // Glide Mode
  params[6] = 1.0;   // Pitch Sigh
  params[7] = 0.4;   // Click
  params[8] = 0.35;   // Drive
  params[9] = 0.0;   // Octave
  params[10] = 2.0;   // Bend Range
  params[11] = 0.6;   // Accent
  params[12] = 1.0;   // Velocity Mode
}
