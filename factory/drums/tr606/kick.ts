// SILVERBOX KICK — the 606 bass drum on its own channel. Any note plays it.
const v = new BD606();
function applyParams(): void { v.level = params[P_LEV]; v.decay = params[P_DEC]; v.tune = params[P_TUNE]; }
