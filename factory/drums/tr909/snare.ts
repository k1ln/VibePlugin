// WAREHOUSE SNARE — one voice of Warehouse 909 on its own mixer channel.
const v = new SD909();
function applyParams(): void {
  v.tune = params[P_TUNE]; v.level = params[P_LEV]; v.tone = params[P_TONE]; v.snappy = params[P_SNAP];
}
