// WAREHOUSE RIDE — one voice of Warehouse 909 on its own mixer channel.
const v = new Cymbal909();
function applyParams(): void {
  v.level = params[P_LEV]; v.tune = params[P_TUNE];
}
export function init(sr: f32, maxFrames: i32, numChannels: i32): void { commonInit(sr); resetNoise909(); v.isRide = true; v.init(); setDefaults(); }
